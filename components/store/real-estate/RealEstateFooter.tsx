        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            {store.logo_url ? (
              ...
              <p className="text-xl font-black mb-4" style={{ color: ACCENT }}>{store.name}</p>
            )}
            ...
            {store.instagram_url && (
              <a
                ...
                className="mt-5 inline-flex items-center gap-2 text-xs font-semibold text-gray-500 hover:text-gray-900 transition-colors"
              >
          ...
          {/* Links */}
          <div>
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-gray-400">Propiedades</p>
            <nav className="flex flex-col gap-2.5">
              {[
                ...
                <Link key={href} href={href} className="text-sm text-gray-500 hover:text-gray-900 transition-colors">
                  {label}
                </Link>
              ))}
            </nav>
          ...
          {/* Contact */}
          <div>
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-gray-400">Contacto</p>
