        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            {store.logo_url && !logoError ? (
              ...
              <p className="text-xl font-black mb-4 text-gray-900">{store.name}</p>
            )}
            ...
            {store.instagram_url && (
              <a
                ...
                className="mt-5 inline-flex items-center gap-2 text-xs font-semibold text-gray-400 hover:text-gray-900 transition-colors"
              >
