    ...
    <footer style={{ backgroundColor: store.color_primary, color: store.color_background }}>
      ...
      {store.whatsapp_number && (
        ...
        >
          <div>
            ...
            <p className="mt-2 text-sm opacity-40">Agendá tu visita o test drive sin compromiso.</p>
          </div>
      ...
      <div className="px-8 py-14 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="col-span-2 md:col-span-1">
          <p className="text-xl font-black uppercase tracking-[-0.02em]" style={{ color: store.color_background }}>
            {store.name}
          </p>
          <div className="mt-1 w-8 h-0.5" style={{ backgroundColor: GOLD }} />
          <p className="mt-4 text-xs leading-relaxed opacity-40 max-w-xs">
          ...
          <div className="mt-5 flex flex-col gap-2">
            {store.whatsapp_number && (
              <a href={`https://wa.me/${store.whatsapp_number.replace(/\D/g, '')}`}
                ...
                className="flex items-center gap-2 text-xs font-semibold opacity-50 hover:opacity-100 transition-opacity">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <Link href="/productos" className="text-xs font-medium opacity-50 hover:opacity-100 transition-opacity">
                Todos los vehículos
              </Link>
            </li>
            {categories.map(cat => (
        ...
        <div>
          ...
          <div className="mt-5 pt-5 border-t" style={{ borderColor: `${store.color_background}12` }}>
      ...
      <div className="border-t px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3"
        style={{ borderColor: `${store.color_background}10` }}>
        <p className="text-[9px] opacity-25 uppercase tracking-[0.15em]">
